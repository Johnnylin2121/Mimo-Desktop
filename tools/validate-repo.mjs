#!/usr/bin/env node
/**
 * validate-repo.mjs — 仓库体检（零依赖，通用）
 *
 * 目的：把"只推非限制性内容"变成可执行的门槛。
 * push 前抓出平台强绑定、密钥、垃圾文件、体积与 frontmatter 问题。
 *
 * 用法：node tools/validate-repo.mjs        （退出码：0 通过，1 有阻塞项）
 * 本仓不依赖 DSH push-guard；隐私由人工 + 本脚本共同把关。
 */
...
// ── 1. skill 目录结构 ──
const NON_SKILL_DIRS = new Set(['_shared', 'tools', 'docs', '.github', '.git']);
